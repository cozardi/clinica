...
public class Joven extends Paciente{
    ...
    /**
     * @return false ya que un paciente Joven no tiene prioridad en la sala por sobre otro paciente Joven.
     */
    ...
    /**
     * @return false ya que un paciente Joven tiene prioridad en la sala por sobre un paciente mayor.
     */
    ...
    /**
     * @return true ya que un paciente Nino tiene prioridad en la sala por sobre un paciente Joven.
     */
