...
public interface Priorizable {
    ...
    /**
     * @return true si el joven tiene prioridad en la sala por sobre el paciente de la clase actual actual, false en caso contrario.
     */

    boolean ganaJoven();

    /**
     * @return true si el Mayor tiene prioridad en la sala por sobre el paciente de la clase actual. False en caso contrario.
     */

    boolean ganaMayor();

    /**
     * @return true si el Nino tiene prioridad en la sala por sobre el paciente de la clase actual. False en caso contrario.
     */
