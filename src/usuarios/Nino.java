...
public class Nino extends Paciente implements Priorizable {
    ...
    /**
     * @return false ya que el Nino tiene prioridad en la sala por sobre el paciente Joven.
     */
    ...
    /**
     * @return true ya que el paciente Mayor tiene prioridad en la sala por sobre el Nino.
     */
    ...
    /**
     * @return false ya que el Nino no tiene prioridad en la sala por sobre otro Nino.
     */
